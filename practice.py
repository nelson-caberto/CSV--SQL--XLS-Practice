...
for int4 in int4as:
	...
	#C
	ws[cell(3,1)] = 'Number of id'
	ws[cell(3,2)] = 'char6 A'
	ws[cell(3,3)] = 'int4 A'
	ws[cell(3,5)] = 'char2'
	ws[cell(3,6)] = 'A'
	result = results[int4]['A']['C']
	for row in result: ws[cell(3,row)] = result[row]

	#D
	ws[cell(4,5)] = 'char2 B'
	ws[cell(4,6)] = 'B'
	result = results[int4]['B']['C']
